...
namespace Legacy_System_UI.Infrastructure
{
    public class LocalizationManager
    {
        ...
        private void InitializeResourceManager()
        {
            try
            {
                _resourceManager = new ResourceManager("Legacy_System_UI.Resources.Strings", typeof(LocalizationManager).Assembly);
            }
            catch
            {
        ...
        // var fullNameAR = await LocalizationManager.GetDbTranslationAsync("Users", currentUser.ID , "FullName") ;
        // LbName.Text = fullNameAR  != "" ? fullNameAR : currentUser.FullName ;
        ...
        private string GetDefaultText(string entityName, int entityId, string fieldName)
        {
            ...
            // var allData = Select @FieldName from @entityName ;
            // var originalText = allData .FindAsync(entityId);
            // return originalText ;
